package com.example.openwrtmanager.ui.active_connection
...
import com.example.openwrtmanager.com.example.openwrtmanager.ui.activite_connection.ActiviteConnectionAdapter
...
import com.example.openwrtmanager.databinding.FragmentActiviteConnectionBinding
...
//    companion object {
//        fun newInstance() = ActiviteConnectionFragment()
//    }
//
//    private lateinit var viewModel: ActiviteConnectionViewModel
//
//    override fun onCreateView(
//        inflater: LayoutInflater, container: ViewGroup?,
//        savedInstanceState: Bundle?
//    ): View? {
//        return inflater.inflate(R.layout.fragment_activite_connection, container, false)
//    }
//
//    override fun onActivityCreated(savedInstanceState: Bundle?) {
//        super.onActivityCreated(savedInstanceState)
//        viewModel = ViewModelProvider(this).get(ActiviteConnectionViewModel::class.java)
//        // TODO: Use the ViewModel
//    }

    private val TAG = ActiveConnectionFragment::class.simpleName
    private var _binding: FragmentActiviteConnectionBinding? = null
    private val binding get() = _binding!!
    private lateinit var ipNetworkViewModel: ActiveConnectionViewModel

    private lateinit var viewModel: ActiveConnectionViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentActiviteConnectionBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = ActiviteConnectionAdapter()
        binding.activiteConnectionRecyclerView.adapter = adapter
        binding.activiteConnectionRecyclerView.layoutManager =
            LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.activiteConnectionRecyclerView.addItemDecoration(DividerItemDecoration(binding.root.context, DividerItemDecoration.VERTICAL))
        binding.activiteConnectionRecyclerView.itemAnimator = null
                    ...
                    when (lce) {
                        ...
                        is LCE.Content -> {
                            ...
                            ipNetworkViewModel.lceLiveData.observe(viewLifecycleOwner, Observer { lce ->
                                when (lce) {
                                    is LCE.Content -> {
                                        val recyclerViewState = binding.activiteConnectionRecyclerView.layoutManager?.onSaveInstanceState()
                                        ...
                                        adapter.submitList(newitem){
                                            binding.activiteConnectionRecyclerView.layoutManager?.onRestoreInstanceState(recyclerViewState)
                                        }
                                    }
...
//                                        Toast.makeText(requireContext(), ("別搞我"), Toast.LENGTH_SHORT).show()
    ...
    private fun setUpViewModel() {
        ...
        val test = AnyViewModelFactory { ActiveConnectionViewModel(infoRep, deviceItemRepo, authenticateRepo) }
        ipNetworkViewModel = ViewModelProvider(requireActivity(), test).get(ActiveConnectionViewModel::class.java)
    }
